...
public class ShoppingCartController implements ShoppingCartOperations {
    ...
    public ShoppingCartDto changeQuantityInShoppingCart(String userName, SetProductQuantityStateRequest setProductQuantityStateRequest) {
        log.info("POST /api/v1/shopping-cart/change-quantity <--> Изменить количество товаров в корзине: userName={}, setProductQuantityStateRequest={}", userName, setProductQuantityStateRequest);
        return shoppingCartService.changeQuantityInShoppingCart(userName, setProductQuantityStateRequest);
    }
